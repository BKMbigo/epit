...
enum class Koin(
    ...
    koin_android_navigation(moduleName = "io.insert-koin:koin-androidx-navigation"),
    koin_android_workmanager(moduleName = "io.insert-koin:koin-androidx-workmanager"),
