...
class EpitAndroidXCorePerformanceScope internal constructor(
    ...
    * */
    ...
    internal val AndroidX.Core.CorePerformance.dependencyAsString
        get(): String = moduleName joinWithColon androidXCorePerformanceVersion

    internal fun AndroidX.Core.CorePerformance.dependencyAsString(version: String) = moduleName joinWithColon version
