...
class EpitAndroidXComposeBomScope internal constructor(
    ...
    * */
    ...
    internal val AndroidX.Compose.ComposeBomDependency.dependencyAsString
        get() = this.moduleName

    internal fun AndroidX.Compose.dependencyAsString(version: String) = moduleName joinWithColon version
